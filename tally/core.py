    ...
    purchase_summary = _summary_rows(
        {
            ...
            "카과": card_tax,
            "현과": cash_tax,
            "카면": purchase[purchase["original_type"].eq("카면")],
            "카영": purchase[purchase["original_type"].eq("카영")],
            "현면": purchase[purchase["original_type"].eq("현면")],
            "현영": purchase[purchase["original_type"].eq("현영")],
            "카드매입": card_total,
            "카드외": card_total,
            "의제매입세액": deemed,
